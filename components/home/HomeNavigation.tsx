...
export function HomeNavigation({ user }: HomeNavigationProps) {
  return (
    <>
      {/* Desktop Navigation */}
      <nav className="hidden lg:block w-full border-b border-b-foreground/10 h-16 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
